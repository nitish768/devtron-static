...
class Wc_ss_btns {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'language_attributes', $plugin_public, 'add_opengraph_doctype' );
		// Add Facebook Meta(s) to the header
		$this->loader->add_action( 'wp_head', $plugin_public, 'insert_fb_in_head', 5 );
		// Add Twitter Card to the header
		$this->loader->add_action( 'wp_head', $plugin_public, 'insert_twitter_card', 5 );

		// If in-content buttons enabled
