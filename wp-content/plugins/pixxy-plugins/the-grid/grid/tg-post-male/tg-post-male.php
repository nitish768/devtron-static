...
*
* Skin Name: Post Male
* Skin Slug: tg-post-male
* Date: 07/27/18 - 03:57:44PM
*
*/
...
$output = null;
	...
	$output .= $tg_el->get_media();
		...
		$output .= $tg_el->get_media_button(array('icons' => array('image' => '<i class="tg-icon-zoom-6"></i>', 'audio' => '<i class="tg-icon-play"></i>', 'video' => '<i class="tg-icon-play"></i>', 'pause' => '')), 'tg-element-3');
