...
/**
 * [pixxy_param_select_preview description]
 * @method pixxy_param_select_preview
 * @param  [type]               $settings [description]
 * @param  [type]               $value    [description]
 * @return [type]                         [description]
 */
vc_add_shortcode_param( 'select_preview', 'pixxy_param_select_preview' );
function pixxy_param_select_preview( $settings, $value ) {
